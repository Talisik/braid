...
export class M3U8Processor {
     ...
     */
    async processM3U8(m3u8Url, outputFileName) {
        try {
            ...
            const conversionSuccess = await this.converter.convertSegmentsToVideo(segmentPaths, outputPath, {
     ...
     */
    async processM3U8WithQuality(m3u8Url, outputFileName, preferredQuality) {
        try {
     ...
     */
    async getAvailableQualities(m3u8Url) {
        try {
     ...
     */
    async processM3U8WithBrowser(m3u8Url, outputFileName, page, networkMonitor) {
        try {
            ...
            const selectedStream = streams.reduce((best, current) => current.quality > best.quality ? current : best);
     ...
     */
    async downloadM3U8WithBrowser(url, page) {
        try {
...
//# sourceMappingURL=M3U8Processor.js.map